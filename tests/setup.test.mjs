...
const MEDIA_TOOLS = ["image_gen", "image_edit", "image_to_video", "reference_to_video"];
const FULL_TOOLSET = ["read_file", "list_dir", "grep", "run_terminal_command", ...MEDIA_TOOLS];
...
function toolDefinitions(names, parameters = {}) {
 ...
 */
function addSession(sandbox, { tools, parameters, media = null, minutesAgo = 0 }) {
  sessionCount += 1;
